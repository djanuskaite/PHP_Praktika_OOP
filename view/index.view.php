...
<div class="container mt-5">
    ...
    $vehicle2 = new Car('Chevrolet', 'Impala', "Automatic", 1967);
    ...
    $vehicle3 = new Car('Nissan', 'Almera Tino', "Manual", 2004);
    ...
    $motorcycle1 = new Motorcycle('Harley Davidson', 'FXLR', "Vivid Black", 2020);
    $motorcycle1->addOtherVehicleData(17999, 672, "yes",
        120, 1, 'Classic Americana meets cutting-edge performance.');
    $motorcycle2 = new Motorcycle('BMW','R NineT Pure', 'Snake Venom', 2021);
    ...
    $motorcycle3 = new Motorcycle('Kawasaki','Ninja', 'Royal Purple', 2020);
    ...
    <h2 class="row d-flex justify-content-center">Motorcycles</h2>
    <table class='table table-bordered text-center table-hover table-responsive'>
        <thead class="thead-dark">
        <tr class='table'>
            <th>Brand</th>
    ...
    $bicycle1 = new Bicycle('Basso', "Volta", "Flat");
